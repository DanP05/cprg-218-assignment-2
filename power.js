...
aventuras.addEventListener('click',function(){
    console.log("Hola me llamo Daniel");
    document.getElementById("image").src="rome.JPG"
...
lecciones.addEventListener('click',function(){
    ...
    document.getElementById("MyP").textContent="When my plane took off from Amsterdam, I looked out over the vast North Sea. This trip wasn’t just a vacation; it was a lesson in independence, spontaneity, and the beauty of connecting with new cultures. I returned home with a full heart and a growing list of destinations for my next adventure."
